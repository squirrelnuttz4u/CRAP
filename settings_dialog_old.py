...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setup_ui()
        self.load_settings()
        # Fetch models asynchronously after the UI is set up
    ...
    async def populate_model_lists(self):
        ...
        if not self.available_models:
            item = QListWidgetItem("No models found. Check Ollama server.")
        ...
        # Re-load settings for the model lists now that they are populated
